...
// void initializeAMiLinearizationAnalysisPCFLPass(PassRegistry &);
// void initializeAMiLinearizationAnalysisSESEPass(PassRegistry &);
void initializeAMiLinearizationAnalysisPass(PassRegistry &);
...
void initializeCompactOrderPass(PassRegistry &);
...
void initializeInsertConflictingDefsPass(PassRegistry &);
void initializeRemoveConflictingDefsPass(PassRegistry &);
...
void initializeFlowGraphPrinterPass(PassRegistry &);
