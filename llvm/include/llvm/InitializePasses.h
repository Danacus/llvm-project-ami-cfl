...
void initializeSensitiveRegionAnalysisPass(PassRegistry &);
// void initializeSensitiveRegionAnalysisVirtRegPass(PassRegistry &);
...
void initializeTrackSecretsAnalysisPass(PassRegistry &);
