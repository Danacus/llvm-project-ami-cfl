...
void llvm::initializeCodeGen(PassRegistry &Registry) {
  ...
  //initializeAMiLinearizeRegionPass(Registry);
  ...
  initializeCompactOrderPass(Registry);
  ...
  initializeFlowGraphPrinterPass(Registry);
  ...
  initializeInsertConflictingDefsPass(Registry);
